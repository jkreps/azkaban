...
*
*/
public class ClojureCombiner extends Reducer<Object, Object, String, String>
  {
    IFn theFunction;
    long currTime;
    ...
    protected void setup(Context context) throws IOException, InterruptedException
    {
        ...
        final String theActualFunction = String.format(
                ...
                "%s\n" +
                "((comp job/reduce-function job/combiner) (nth the-jobs %s))",
        ...
        try {
            ...
            this.theFunction = (IFn) clojure.lang.Compiler.load(new StringReader(theActualFunction), "clj-combiner", "source-clj");
        }
        catch (Exception e) {
            throw new RuntimeException(e);
        }

        System.out.printf("Clojure combiner startup in %s millis.%n", System.currentTimeMillis() - currTime);
        currTime = System.currentTimeMillis();
    }


    @Override
    protected void reduce(Object key, Iterable<Object> value, Context context) throws IOException, InterruptedException
    {
        try {
    ...
    protected void cleanup(Context context) throws IOException, InterruptedException
    {
        ...
        System.out.printf("Combiner ran in %s millis.%n", System.currentTimeMillis() - currTime);
    }
  }
