 ...
 *
 */
public class ClojureReducer extends Reducer<Object, Object, String, String>
{
    IFn theFunction;
    long currTime;
    ...
    protected void setup(Context context) throws IOException, InterruptedException
    {
        ...
        final String theActualFunction = String.format(
                ...
                "%s\n" +
                "((comp job/reduce-function job/reducer) (nth the-jobs %s))",
        ...
        try {
            ...
            this.theFunction = (IFn) clojure.lang.Compiler.load(new StringReader(theActualFunction), "clj-reducer", "source-clj");
        }
        catch (Exception e) {
            throw new RuntimeException(e);
        }

        System.out.printf("Clojure reducer startup in %s millis.%n", System.currentTimeMillis() - currTime);
        currTime = System.currentTimeMillis();
    }
    ...
    protected void cleanup(Context context) throws IOException, InterruptedException
    {
        ...
        System.out.printf("Reducer ran in %s millis.%n", System.currentTimeMillis() - currTime);
    }
}
